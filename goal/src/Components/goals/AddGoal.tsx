...
function AddGoal() {
  return (
    ...
    <div>
        ...
        <div className="pt-3">
            <input className="w-full h-12 px-2 py-2 rounded" type="text" placeholder='Goal Name' />
        </div>
        <div className="pt-3 ">
        ...
        <div className="pt-3 ">
            ...
            <input className="w-full h-12 px-2 py-2 rounded-r-lg" type="number" placeholder='Goal Target' />
            </div>
        </div>
